...
static const _ObstacleInfo_type_support_symbol_names_t _ObstacleInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sonia_common_ros2, msg, ObstacleInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sonia_common_ros2, msg, ObstacleInfo)),
  }
};
...
{
  return &::sonia_common_ros2::msg::rosidl_typesupport_cpp::ObstacleInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sonia_common_ros2, msg, ObstacleInfo)() {
  return get_message_type_support_handle<sonia_common_ros2::msg::ObstacleInfo>();
}
