...
static const _SerialService_Request_type_support_symbol_names_t _SerialService_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sonia_common_ros2, srv, SerialService_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sonia_common_ros2, srv, SerialService_Request)),
  }
};
...
{
  return &::sonia_common_ros2::srv::rosidl_typesupport_cpp::SerialService_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sonia_common_ros2, srv, SerialService_Request)() {
  return get_message_type_support_handle<sonia_common_ros2::srv::SerialService_Request>();
}
...
static const _SerialService_Response_type_support_symbol_names_t _SerialService_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sonia_common_ros2, srv, SerialService_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sonia_common_ros2, srv, SerialService_Response)),
  }
};
...
{
  return &::sonia_common_ros2::srv::rosidl_typesupport_cpp::SerialService_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sonia_common_ros2, srv, SerialService_Response)() {
  return get_message_type_support_handle<sonia_common_ros2::srv::SerialService_Response>();
}
...
static const _SerialService_type_support_symbol_names_t _SerialService_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sonia_common_ros2, srv, SerialService)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sonia_common_ros2, srv, SerialService)),
  }
};
...
{
  return &::sonia_common_ros2::srv::rosidl_typesupport_cpp::SerialService_service_type_support_handle;
}
