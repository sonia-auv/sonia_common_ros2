...
#include "sonia_common_ros2/msg/detail/mission_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sonia_common_ros2::msg::MissionStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sonia_common_ros2::msg::MissionStatus & ros_message)
{
  // Member: status
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const sonia_common_ros2::msg::MissionStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sonia_common_ros2::msg::MissionStatus *>(
    untyped_ros_message);
...
{
  return &sonia_common_ros2::msg::typesupport_fastrtps_cpp::_MissionStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sonia_common_ros2, msg, MissionStatus)() {
  return &sonia_common_ros2::msg::typesupport_fastrtps_cpp::_MissionStatus__handle;
}
