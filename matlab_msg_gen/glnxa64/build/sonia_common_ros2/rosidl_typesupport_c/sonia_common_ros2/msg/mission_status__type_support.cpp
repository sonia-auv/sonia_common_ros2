...
#include "sonia_common_ros2/msg/detail/mission_status__type_support.h"
...
static const _MissionStatus_type_support_symbol_names_t _MissionStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sonia_common_ros2, msg, MissionStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sonia_common_ros2, msg, MissionStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sonia_common_ros2, msg, MissionStatus)() {
  return &::sonia_common_ros2::msg::rosidl_typesupport_c::MissionStatus_message_type_support_handle;
}
