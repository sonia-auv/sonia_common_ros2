...
#include "sonia_common_ros2/msg/detail/obstacle_array__type_support.h"
...
static const _ObstacleArray_type_support_symbol_names_t _ObstacleArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sonia_common_ros2, msg, ObstacleArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sonia_common_ros2, msg, ObstacleArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sonia_common_ros2, msg, ObstacleArray)() {
  return &::sonia_common_ros2::msg::rosidl_typesupport_c::ObstacleArray_message_type_support_handle;
}
