...
{
  new (message_memory) sonia_common_ros2::msg::MissionStatus(_init);
}

void MissionStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<sonia_common_ros2::msg::MissionStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MissionStatus_message_member_array[1] = {
  {
    ...
    offsetof(sonia_common_ros2::msg::MissionStatus, status),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MissionStatus_message_members = {
  ...
  1,  // number of fields
  sizeof(sonia_common_ros2::msg::MissionStatus),
...
{
  return &::sonia_common_ros2::msg::rosidl_typesupport_introspection_cpp::MissionStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sonia_common_ros2, msg, MissionStatus)() {
  return &::sonia_common_ros2::msg::rosidl_typesupport_introspection_cpp::MissionStatus_message_type_support_handle;
}
