...
{
  new (message_memory) sonia_common_ros2::msg::ObstacleArray(_init);
}

void ObstacleArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<sonia_common_ros2::msg::ObstacleArray *>(message_memory);
  typed_message->~ObstacleArray();
}

size_t size_function__ObstacleArray__obstacles(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<sonia_common_ros2::msg::ObstacleInfo> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<sonia_common_ros2::msg::ObstacleInfo> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<sonia_common_ros2::msg::ObstacleInfo> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const sonia_common_ros2::msg::ObstacleInfo *>(
    get_const_function__ObstacleArray__obstacles(untyped_member, index));
  auto & value = *reinterpret_cast<sonia_common_ros2::msg::ObstacleInfo *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<sonia_common_ros2::msg::ObstacleInfo *>(
    get_function__ObstacleArray__obstacles(untyped_member, index));
  const auto & value = *reinterpret_cast<const sonia_common_ros2::msg::ObstacleInfo *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ObstacleArray_message_member_array[2] = {
  {
    ...
    offsetof(sonia_common_ros2::msg::ObstacleArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<sonia_common_ros2::msg::ObstacleInfo>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(sonia_common_ros2::msg::ObstacleArray, obstacles),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObstacleArray_message_members = {
  ...
  2,  // number of fields
  sizeof(sonia_common_ros2::msg::ObstacleArray),
...
get_message_type_support_handle<sonia_common_ros2::msg::ObstacleArray>()
{
  return &::sonia_common_ros2::msg::rosidl_typesupport_introspection_cpp::ObstacleArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sonia_common_ros2, msg, ObstacleArray)() {
  return &::sonia_common_ros2::msg::rosidl_typesupport_introspection_cpp::ObstacleArray_message_type_support_handle;
}
