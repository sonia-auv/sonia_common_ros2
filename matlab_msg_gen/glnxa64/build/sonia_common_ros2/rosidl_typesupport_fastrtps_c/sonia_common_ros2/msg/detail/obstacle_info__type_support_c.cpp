...
#include "sonia_common_ros2/msg/detail/obstacle_info__rosidl_typesupport_fastrtps_c.h"
...
using _ObstacleInfo__ros_msg_type = sonia_common_ros2__msg__ObstacleInfo;
...
static uint32_t _ObstacleInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sonia_common_ros2__msg__ObstacleInfo(
...
static size_t _ObstacleInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sonia_common_ros2__msg__ObstacleInfo(
