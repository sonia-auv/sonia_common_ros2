...
#include "sonia_common_ros2/msg/detail/mission_status__rosidl_typesupport_fastrtps_c.h"
...
using _MissionStatus__ros_msg_type = sonia_common_ros2__msg__MissionStatus;
...
size_t get_serialized_size_sonia_common_ros2__msg__MissionStatus(
  const void * untyped_ros_message,
...
static uint32_t _MissionStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sonia_common_ros2__msg__MissionStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sonia_common_ros2
size_t max_serialized_size_sonia_common_ros2__msg__MissionStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _MissionStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sonia_common_ros2__msg__MissionStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sonia_common_ros2, msg, MissionStatus)() {
