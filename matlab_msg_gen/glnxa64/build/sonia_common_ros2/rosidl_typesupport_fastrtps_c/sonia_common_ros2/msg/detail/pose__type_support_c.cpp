...
#include "sonia_common_ros2/msg/detail/pose__rosidl_typesupport_fastrtps_c.h"
...
using _Pose__ros_msg_type = sonia_common_ros2__msg__Pose;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: fine
  {
    cdr << ros_message->fine;
  }

  // Field name: rotation
  {
    cdr << (ros_message->rotation ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: rotation
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->rotation = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name fine
  {
    size_t item_size = sizeof(ros_message->fine);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name rotation
...
static uint32_t _Pose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sonia_common_ros2__msg__Pose(
...
static size_t _Pose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sonia_common_ros2__msg__Pose(
