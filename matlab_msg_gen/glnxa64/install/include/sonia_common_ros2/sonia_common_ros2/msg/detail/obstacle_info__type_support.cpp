...
{
  new (message_memory) sonia_common_ros2::msg::ObstacleInfo(_init);
}

void ObstacleInfo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<sonia_common_ros2::msg::ObstacleInfo *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ObstacleInfo_message_member_array[4] = {
  {
    ...
    offsetof(sonia_common_ros2::msg::ObstacleInfo, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sonia_common_ros2::msg::ObstacleInfo, is_valid),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sonia_common_ros2::msg::ObstacleInfo, confidence),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sonia_common_ros2::msg::ObstacleInfo, pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObstacleInfo_message_members = {
  ...
  4,  // number of fields
  sizeof(sonia_common_ros2::msg::ObstacleInfo),
...
{
  return &::sonia_common_ros2::msg::rosidl_typesupport_introspection_cpp::ObstacleInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sonia_common_ros2, msg, ObstacleInfo)() {
  return &::sonia_common_ros2::msg::rosidl_typesupport_introspection_cpp::ObstacleInfo_message_type_support_handle;
}
